...
const PropertyRejectedPage: React.FC = () => {
  ...
  const handleReactivate = (propertyId: string): void => {
    console.log('Reactivate property:', propertyId);
  };
  ...
  return (
    <div className="min-h-screen bg-white font-['Outfit'] text-slate-800">
      ...
      <PageHeader
        ...
        subtitle={`Tổng ${filteredProperties.length} bất động sản bị từ chối`}
      />
      ...
      <div>
        ...
        {filteredProperties.length === 0 && (
          <EmptyState
            title="Không có bất động sản bị từ chối"
            message="Chưa có bất động sản nào bị từ chối"
          />
        )}
      </div>
