...
import { propertyTypeLabels, furnitureLabels, formatCurrency, formatDate, getTimeAgo } from '../../utils/property.utils';
    ...
    >
      ...
      <div className="!p-4">
        ...
        <div className="grid grid-cols-3 gap-2 !mb-3 !p-3 bg-slate-50 rounded-lg border border-slate-100">
          ...
          <div className="text-center">
            <div className="text-[10px] text-slate-500 !mb-0.5 font-medium">Phòng ngủ</div>
            <div className="text-sm font-bold text-blue-600">{property.bedrooms}</div>
          </div>
          <div className="text-center">
            <div className="text-[10px] text-slate-500 !mb-0.5 font-medium">P. Tắm</div>
            <div className="text-sm font-bold text-blue-600">{property.bathrooms}</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between !mb-3 !p-3 bg-blue-50 rounded-lg border border-blue-100">
          ...
          {property.furnitureStatus && (
            <div className="!px-2 !py-1 bg-blue-100 rounded-md text-[10px] font-semibold text-blue-600">
              {furnitureLabels[property.furnitureStatus]}
            </div>
          )}
        </div>
