...
export default function ContractsPage() {
  ...
  useEffect(() => {
    if (!smartCAModalOpen || !signingContractId || !signingRole) return;
    if (smartca.signStatus !== "PROCESSING") return;

    const pollContractStatus = () => dispatch(getContractSignStatus(signingContractId));
  ...
  }, [dispatch, signingContractId, signingRole, smartCAModalOpen, smartca.signStatus]);
